<template>
    <div class="page-content">
        ...
        <div class="question-content">
            ...
            <p class="answer">You can RSVP through the form on this website, or you can call/text and email us as well. Just please be sure to include your meal choices!</p>
            ...
            <p class="answer">We love your little ones! However, to allow all of our guests, including parents, the chance to have an evening of relaxation, we request that the ceremony and reception be for adults only.</p>
            <p class="question">Do you have a hotel block for guests? Where do you recommend I stay?</p>
            <p class="answer">Yes we have a number of rooms blocked at the DoubleTree by Hilton in Leominster. Address and directions are available in the <a href="./lodging">Lodging tab.</a></p>
