<template>
    <div class="page-content">
        ...
        <div class="question-content">
            ...
            <p class="answer">Yes we have a number of rooms blocked at the DoubleTree by Hilton in Leominster. Address and directions are available in the <a href="./travel">Lodging tab</a>.</p>
